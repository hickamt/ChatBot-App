/**
 * This file handles the local THEME state
 * for the client side. After closing the application
 * a call to getState will set the applications state
 * to the users desired preferences.
 */
const fs = require("fs");
