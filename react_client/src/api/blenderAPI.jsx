 ...
 */
async function blenderAPI(prompt, setMessageHistory, setIsData) {
  try {
    const response = await axios.post("http://localhost:5500/fb_blender", {
      headers: {
    ...
    console.error(`Error: unable to fetch ${prompt} from the FB Blender Server`, error);
